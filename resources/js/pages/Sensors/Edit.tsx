                ...
                <div className="flex-1 md:max-w-2xl">
                    <section className="max-w-xl space-y-12">
                        <div className="space-y-6">
                            <HeadingSmall title="Update a sensor" description="Enter the details to update this sensor" />
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <Transition
                                        ...
                                        leaveTo="opacity-0"
                                    >
                                        <p className="text-sm text-neutral-600 dark:text-neutral-400">Sensor updated successfully!</p>
                                    </Transition>
                                </div>
                            </form>
                        </div>
